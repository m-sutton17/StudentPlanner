...
class ActivityManagementForm(Form):
    #initialisation
    def __init__(self):
        self.Text = 'Activity Management'
        self.Name = 'frmActivityManagement'
    ...
    def initialiseControls(self):
        ...
        # edit button
        self.btnEdit = Button()
        self.btnEdit.Text = 'Edit Activity'
        self.btnEdit.Location = Point(1100, 200)
        
        # remove button
        self.btnRemove = Button()
        self.btnRemove.Text = 'Remove Activity'
        ...
        self.btnAddActivity.Text = 'Add Activity'
